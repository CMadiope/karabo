...
const Film = ({ pictures }) => {
  return (
    <main className=' pb-12'>
      <Head>
        <title>Karabo Mdluli | Film</title>
        <meta
          name='description'
      ...
      <h3 className='uppercase py-10  font-bold text-2xl text-center'>Film</h3>
      <div className=' columns-1 gap-10 sm:columns-2  md:columns-3 lg:columns-4 max-sm:px-6 sm:px-8'>
